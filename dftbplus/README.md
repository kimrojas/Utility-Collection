...
## Using DFTB+ installation

Here is how to initialize the environment in order to use the DFTB+ installation
.

You simply add the following lines to your script before invoking DFTB+ commands
.
...
> _NOTE: Documentation says that the stable release already contains the external components but no they don't_
...
> _Note: As of the moment, both installation have not yet rigourously tested_
